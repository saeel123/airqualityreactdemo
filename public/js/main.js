$(function(){
    ...
    $('input:radio[name="station-select"]').change(
        function(){
            if (this.checked) {
                $(this).closest('form').find('.radio-group select').attr('disabled','disabled');
...
function generateMap(mapId){
    ...
    L.tileLayer('https://api.maptiler.com/maps/basic-v2/{z}/{x}/{y}.png?key=0uLu36LXLIpQ3Rd7o9FV',{
